...
class TCCommunicator: NSObject, ITCCommunicator, MCNearbyServiceAdvertiserDelegate, MCNearbyServiceBrowserDelegate, MCSessionDelegate {
    ...
    func send(message text: String,
              toUserWithUserId userID: String, completionHandler: ((_ success: Bool, _ error: Error?) -> ())?){
        delegate?.didSend(message: text, toUserWithId: userID)
    ...
    func session(_ session: MCSession, didReceive data: Data, fromPeer peerID: MCPeerID) {
        ...
        do{
            ...
            if message.eventType == "TextMessage" {
                ...
                delegate?.didReceive(message: message.text, fromUserWithId: peerID.displayName)
            } else {
    ...
    func advertiser(_ advertiser: MCNearbyServiceAdvertiser, didReceiveInvitationFromPeer peerID: MCPeerID, withContext context: Data?, invitationHandler: @escaping (Bool, MCSession?) -> Void) {
        ...
        if let userName = peersByDesplayName[peerID.displayName]?.info?["userName"]{
            delegate?.userDidBecomeOnline(userId: peerID.displayName, withName: userName)
        }
    ...
    func browser(_ browser: MCNearbyServiceBrowser, foundPeer peerID: MCPeerID, withDiscoveryInfo info: [String : String]?) {
        ...
        delegate?.userDidBecomeOnline(userId: peerID.displayName, withName: name)
    }
    ...
    func browser(_ browser: MCNearbyServiceBrowser, lostPeer peerID: MCPeerID) {
        ...
        delegate?.userDidBecomeOffine(userId: peerID.displayName)
    }
}
